...
const Card=({allcampaign,setOpenModel,setDonate,title}) =>{
    ...
    return (
        ...
        <div className="grid gap-5 1g:grid-cols-3 sm: max-w-sm sm:mx-auto lg:max-w-full">
        ...
        <img src="https://images.pexels.com/photos/922638/pexels-photo-932638.jpeg? 
        auto-compress&amp; cs=tinys rgb&amp; dpr=3&amp;h=750&amp;w=1260" 
        className="object-cover w-full h-64 rounded"
        alt=""
        />

        <div className="py-5 pl2">
            ...
            href="/"
            aria-label="Article"
            className="inline-block mb-3 text-black transition-colors duration-200 hov:text-deep-purple-accent-700"
            >
            <p className="text-2xl font-bold leading-5">{campaign.title}</p>
            </a>
            <p className="mb-4 text-gray-700">{campaign.describe}</p>
            <div className="flex space-x-4">
                <p className="font-semibold">Target: {campaign.target}ETH</p>

                <p className="font-semibold">
                    Raised: {campaign.amountColllected}ETH
                    </p>
                </div>
            </div>
        </div>
