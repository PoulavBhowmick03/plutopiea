    ...
    const[campaign, setCampaign] = useState({
     ...
     const createNewCampaign = async (e) => {
        ...
        return (
            ...
            <div className="relative px-4 py 16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-sl md:px-24 lg:px lg:py-20 ">
                <div className="flex flex-col items-center justify-between xl:flex-row">
                    <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leadig-none " >
                Crypto King <br className="hidden md:block"/>
                Crowd Funding 
            </h2>
            <p className="max-w-xl mb-4 text-base text-white md:text-lg">
                bhvuegdhklendjnwudd hwjdjw dwbbdjwbjd wbdjnjwd
                vwj shvhggs vhcghc drdtrds fsysfy vsus bsubbsjh hhjdns sggddbbdbj
                dgdgdhd.
            </p> 
            <a href="/"
            aria-label=""
